...
class TestOrderProduct(TestCase):
    ...
    def test_get_order_product(self):
        ...
        self.assertIn(str(self.new_order_product.order_id).encode(), response.content)
    ...
    def test_delete_order_product(self):
        ...
        response = self.client.delete(
           (reverse('orderproduct-list')+f'/{str(self.new_order_product.id)}'), new_order_product, HTTP_AUTHORIZATION='Token ' + str(self.token), content_type="application/json"
          )
